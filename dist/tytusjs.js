    ...
    mapearGenerarDistancia(t) {
        ...
        for (let a = 0, e = this.data.length; a < e; a++) {
            ...
            (!s || l < s) && (i.push({
                ...
                distance: l,
                label: n
            }), i.sort((t, i) => t.distance < i.distance ? -1 : 1), i.length > this.k && i.pop(), s = i[i.length - 1].distance)
        }
        return i
    }
    predecir(t) {
        const i = this.mapearGenerarDistancia(t).slice(0, this.k),
            s = i.reduce((t, i) => Object.assign({}, t, {
                [i.label]: (t[i.label] || 0) + 1
            }), {});
        return {
            label: Object.keys(s).map(t => ({
                label: t,
                count: s[t]
...
var tabla = new Array(new Array("Outlook", "Temperature", "Humidity", "Windy", "Class"), new Array("sunny", "hot", "high", "false", "N"), new Array("sunny", "hot", "high", "true", "N"), new Array("overcast", "hot", "high", "false", "P"), new Array("rain", "mild", "high", "false", "P"), new Array("rain", "cool", "normal", "false", "P"), new Array("rain", "cool", "normal", "true", "N"), new Array("overcast", "cool", "normal", "true", "P"), new Array("sunny", "mild", "high", "false", "N"), new Array("sunny", "cool", "normal", "false", "P"), new Array("rain", "mild", "normal", "false", "P"), new Array("sunny", "mild", "normal", "true", "P"), new Array("overcast", "mild", "high", "true", "P"), new Array("overcast", "hot", "normal", "false", "P"), new Array("rain", "mild", "high", "true", "N")),
    ejemplo2 = new Array(new Array("Empleo", "Ingresos", "Credito"), new Array("si", "3000", "P"), new Array("si", "1000", "N"), new Array("no", "0", "N"), new Array("si", "1500", "P"), new Array("si", "2000", "P"), new Array("no", "0", "N")),
    ejemplo3 = new Array(new Array("Presion Arterial", "Urea en Sangre", "Gota", "Hipotiroidismo", "Admin"), new Array("Alta", "Alta", "Si", "No", "No"), new Array("Alta", "Alta", "Si", "Si", "No"), new Array("Normal", "Alta", "Si", "No", "Si"), new Array("Baja", "Normal", "Si", "No", "Si"), new Array("Baja", "Baja", "No", "No", "Si"), new Array("Baja", "Baja", "No", "Si", "No"), new Array("Normal", "Baja", "No", "Si", "Si"), new Array("Alta", "Normal", "Si", "No", "No"), new Array("Alta", "Baja", "No", "No", "Si"), new Array("Baja", "Normal", "No", "No", "Si"), new Array("Alta", "Normal", "No", "Si", "Si"), new Array("Normal", "Normal", "Si", "Si", "Si"), new Array("Normal", "Alta", "No", "No", "Si"), new Array("Baja", "Normal", "Si", "Si", "No")),
    ejemplo1 = new Array(new Array("Outlook", "Temperature", "Humidity", "Windy", "Class"), new Array("sunny", "hot", "high", "false", "N"), new Array("sunny", "hot", "high", "true", "N"), new Array("overcast", "hot", "high", "false", "P"), new Array("rain", "mild", "high", "false", "P"), new Array("rain", "cool", "normal", "false", "P"), new Array("rain", "cool", "normal", "true", "N"), new Array("overcast", "cool", "normal", "true", "P"), new Array("sunny", "mild", "high", "false", "N"), new Array("sunny", "cool", "normal", "false", "P"), new Array("rain", "mild", "normal", "false", "P"), new Array("sunny", "mild", "normal", "true", "P"), new Array("overcast", "mild", "high", "true", "P"), new Array("overcast", "hot", "normal", "false", "P"), new Array("rain", "mild", "high", "true", "N")),
    varGanar = "P",
    varPerder = "N",
    totalGanar = 0,
    totalPerder = 0,
...
function cantidadPosicion(e, r, a, n) {
    let t = 0;
    for (let o = 1; o < n.length; o++) e == n[o][a] && r == n[o][n[0].length - 1] && t++;
    return t
}
...
function entropia(e, r) {
    ...
    for (let n = 0; n < a.length; n++)
        for (let t = 1; t < r.length; t++) {
            let o = r[t][e];
            o == a[n].nombre && varGanar == r[t][r[0].length - 1] ? a[n].ganar++ : o == a[n].nombre && varPerder == r[t][r[0].length - 1] && a[n].perder++
        }
...
function id3(e) {
    totalGanar = cantidad(varGanar, e), totalPerder = cantidad(varPerder, e), total = totalGanar + totalPerder, varIG = informacionGeneral();
    let r = 0,
        a = "";
    for (let n = 1; n < e[0].length; n++) varEntropia = entropia(n - 1, e), (varGanancia = ganancia(varIG, varEntropia)) > r && (r = varGanancia, a = e[0][n - 1]);
    return a
}
...
function revisarAmbiguedad(e, r, a) {
    let n = 0,
        t = 0;
    for (let o = 0; o < e.length; o++) e[o][a] == r && e[o][e[0].length - 1] == varGanar ? n++ : e[o][a] == r && e[o][e[0].length - 1] == varPerder && t++;
...
function getNodo(e, r, a, n) {
    ...
    for (let o = 0; o < r.length; o++) {
        ...
        if (1 == d) {
            ...
            t += getNodo(l, listaAtributo(obtenerPosicionEncabezado(m = id3(e), e), e), e, m)
...
function treeDirec() {
    ...
    return e += getNodo(iterador - 1, a, tabla, r), e += "}", console.log(e), e
}
...
function Mejemplo1() {
    ...
    a.id = "mynetwork", document.getElementById("b").appendChild(a), tabla = ejemplo3;
...
function Mejemplo2() {
    ...
    e.removeChild(r);
    var a = document.createElement("div");
    a.id = "mynetwork", document.getElementById("b").appendChild(a), tabla = ejemplo2;
    var n = document.getElementById("mynetwork"),
        t = treeDirec(),
        o = vis.network.convertDot(t),
        l = {
...
function Mejemplo3() {
    ...
    e.removeChild(r);
    var a = document.createElement("div");
    a.id = "mynetwork", document.getElementById("b").appendChild(a), tabla = ejemplo1;
    var n = document.getElementById("mynetwork"),
        t = treeDirec(),
        o = vis.network.convertDot(t),
        l = {
...
class Kmeans_G13 {
    constructor(t) {
        this.canvas = t.canvas, this.context = this.canvas.getContext("2d"), this.width = this.canvas.width, this.height = this.canvas.height, this.k = t.k, this.data = t.data, this.assignments = [], this.extents = this.Dimensions(), this.ranges = this.dataExtentRanges(), this.means = this.seeds(), this.clusterColors = this.clusterColors(), this.iterations = t.iterations, this.context.fillStyle = "#FFFFFF", this.context.fillRect(0, 0, this.width, this.height), this.draw(), this.drawDelay = 50, this.run()
    }
    Dimensions() {
        for (var t = [], s = 0; s < this.data.length; s++)
            for (var i = this.data[s], e = 0; e < i.length; e++) t[e] || (t[e] = {
                min: 1e3,
                max: 0
            }), i[e] < t[e].min && (t[e].min = i[e]), i[e] > t[e].max && (t[e].max = i[e]);
        return t
    }
    dataExtentRanges() {
        for (var t = [], s = 0; s < this.extents.length; s++) t[s] = this.extents[s].max - this.extents[s].min;
        return t
    }
    seeds() {
        for (var t = []; this.k--;) {
            for (var s = [], i = 0; i < this.extents.length; i++) s[i] = this.extents[i].min + Math.random() * this.ranges[i];
            t.push(s)
        }
        return t
    }
    ...
    moveMeans() {
        var t, s, i, e, h = this.fillArray(this.means.length, 0),
            n = this.fillArray(this.means.length, 0),
            a = !1;
        for (t = 0; t < this.means.length; t++) h[t] = this.fillArray(this.means[t].length, 0);
        ...
        for (s = 0; s < h.length; s++)
            if (0 !== n[s])
                for (i = 0; i < h[s].length; i++) h[s][i] /= n[s], h[s][i] = Math.round(100 * h[s][i]) / 100;
            else
                for (h[s] = this.means[s], i = 0; i < this.extents.length; i++) h[s][i] = this.extents[i].min + Math.random() * this.ranges[i];
        if (this.means.toString() !== h.toString())
            for (a = !0, s = 0; s < h.length; s++)
                for (i = 0; i < h[s].length; i++)
                    if (e = h[s][i] - this.means[s][i], Math.abs(e) > .1) {
                        this.means[s][i] += e / 10, this.means[s][i] = Math.round(100 * this.means[s][i]) / 100
                    } else this.means[s][i] = h[s][i];
        return a
    }
    run() {
        ++this.iterations, this.assignments = this.assignClusterToDataPoints(), this.moveMeans() && (this.draw(), this.timer = setTimeout(this.run.bind(this), this.drawDelay))
    }
    draw() {
        var t, s;
        for (this.context.fillStyle = "rgba(255,255,255, 0.2)", this.context.fillRect(0, 0, this.width, this.height), s = 0; s < this.assignments.length; s++) {
    ...
    clusterColors() {
        for (var t = [], s = 0; s < this.data.length; s++) t.push("#" + (Math.random() * (1 << 24) | 0).toString(16));
        return t
    }
    clusterColor(t) {
...
const h = t => thetaInicial + theta1 * t,
    learn = t => {
        let e = 0,
            a = 0;
        for (let t = 0; t < 9; t++) e += h(x[t]) - y[t], a += (h(x[t]) - y[t]) * x[t];
...
function GradienteDescendente() {
    ...
    for (t = 0; t < 18e4; t++) {
        if (learn(tasaAprendisaje), t % 6e3 == 0) {
            let a = {
                Iteracion: t,
                Funcion: "f(x) = " + thetaInicial.toFixed(2) + " + " + theta1.toFixed(2) + "x"
            };
            e.push(a)
        }
        t++
...
function LineLeastSquares(e, r) {
    var n = 0,
        ...
        h = 0,
        g = [];
    if (e.length != r.length) throw new Error("Los array ingresados deben ser del mismo tamaño");
    for (let g = 0; g < e.length; g++) o += l = e[g], s += h = r[g], n += l * l, t += l * h, a++;
...
class G8_Kmeans {
    constructor(t) {
        this.canvas = t.canvas, this.context = this.canvas.getContext("2d"), this.width = this.canvas.width, this.height = this.canvas.height, this.k = t.k, this.data = t.data, this.assignments = [], this.extents = this.dataDimensionExtents(), this.ranges = this.dataExtentRanges(), this.means = this.seeds(), this.clusterColors = this.clusterColors(), this.iterations = 0, this.context.fillStyle = "rgb(255,255,255)", this.context.fillRect(0, 0, this.width, this.height), this.draw(), this.drawDelay = 20, this.run()
    }
    ...
    run() {
        ++this.iterations, this.assignments = this.assignClusterToDataPoints(), this.moveMeans() ? (this.draw(), this.timer = setTimeout(this.run.bind(this), this.drawDelay)) : console.log("Iteration took for completion: " + this.iterations)
    }
    draw() {
        var t, s;
        for (this.context.fillStyle = "rgba(255,255,255, 0.2)", this.context.fillRect(0, 0, this.width, this.height), s = 0; s < this.assignments.length; s++) {
...
class BayesMethod {
    constructor() {
        this.attributes = [], this.classes = [], this.frecuencyTables = [], this.attributeNames = [], this.className = null
    }
    addAttribute(t, e) {
    ...
    train() {
        ...
        return this.frecuencyTables.push(t), this.attributes.forEach((e, r) => {
            let s = this.frecuencyTables[r];
            var i = [];
            s.values.forEach((r, o) => {
                var n = [];
                t.values.forEach((t, i) => {
                    n.push(0), e.forEach((e, s) => {
    ...
    probability(t, e, r) {
        ...
        return i.valueClassProbabilities[o][a] * i.probabilities[o] / n.probabilities[a]
    }
    predict(t, e = null) {
        var r = [],
            s = this.frecuencyTables[this.frecuencyTables.length - 1];
        if (s.values.forEach((e, i) => {
    ...
    isModelValid() {
        ...
        if (!this.attributes) return !1;
        {
            let t = this.attributes[0].length,
                e = !0;
            if (this.attributes.forEach(r => e = e && r.length == t), !(e = e && this.classes.length)) return console.log("attributes and class must have the same ammount of elements"), !1
        }
        return !0
    }
    toFrecuencyTable(t) {
...
class NodeTree {
    constructor(t = null, e = "", r = []) {
        this.id = Math.random().toString(15).substr(3, 12), this.tag = e, this.value = t, this.childs = r
    }
}
class Feature {
    constructor(t, e, r) {
        this.attribute = t, this.entropy = -1, this.gain = -1, this.primaryCount = 0, this.secondaryCount = 0, this.primaryPosibility = e, this.secondPosibility = r
    }
    updateFeature(t) {
        ...
        return this.entropy = this.calculateEntropy(this.primaryCount, this.secondaryCount), !0
    }
    calculateEntropy(t, e) {
        let r = -1;
        return 0 == t || 0 == e ? 0 : (r = -t / (t + e) * Math.log2(t / (t + e)), r += -e / (t + e) * Math.log2(e / (t + e)))
    }
}
class Attribute {
    constructor(t) {
        this.attribute = t, this.features = [], this.infoEntropy = -1, this.gain = -1, this.index = -1
    }
}
class DecisionTreeID3 {
    constructor(t = []) {
        this.dataset = t, this.generalEntropy = -1, this.primaryCount = -1, this.secondaryCount = -1, this.primaryPosibility = "", this.secondPosibility = "", this.root = null
    }
    calculateEntropy(t, e) {
        let r = -1;
        return 0 == t || 0 == e ? 0 : (r = -t / (t + e) * Math.log2(t / (t + e)), r += -e / (t + e) * Math.log2(e / (t + e)))
    ...
    train(t, e = 0) {
        ...
        for (let o = e; o < s; o++) {
            ...
            e.index = o, e.features = this.classifierFeatures(t, o, r), e.infoEntropy = this.calculateInformationEntropy(e.features), e.gain = this.calculateGain(this.generalEntropy, e.infoEntropy), i.push(e)
        }
        if (0 == i.length) return null;
        let o = this.selectBestFeature(i),
            n = new NodeTree(i[o].attribute);
        return i[o].features.map(r => {
            let s = new NodeTree(null);
            if (0 == r.entropy) s.value = 0 == r.primaryCount ? r.secondPosibility : r.primaryPosibility;
            else {
        ...
        for (let r = 0; r < t[0].length; r++)
            if (t[0][r] === e.value)
                for (let s = 0; s < e.childs.length; s++)
                    if (e.childs[s].tag === t[1][r]) return this.recursivePredict(t, e.childs[s]);
        return null
    }
    calculateGeneralEntropy(t, e) {
        let r = {
            ...
            i = !1;
        return t.map(t => {
            i ? r.tag ? s.tag || t[e] == r.tag ? r.tag === t[e] ? r.count += 1 : s.tag === t[e] && (s.count += 1) : (s.tag = t[e], s.count += 1) : (r.tag = t[e], r.count += 1) : i = !0
        }), this.primaryPosibility = r.tag, this.secondPosibility = s.tag, this.primaryCount = r.count, this.secondaryCount = s.count, this.generalEntropy = this.calculateEntropy(r.count, s.count), this.generalEntropy
    }
        ...
        return t.map(t => {
            if (i) {
                ...
                if (i > -1) s[i].updateFeature(t[r]);
                    ...
                    let i = new Feature(t[e], this.primaryPosibility, this.secondPosibility);
    ...
    calculateInformationEntropy(t) {
        let e = 0;
        return t.map(t => {
            e += (t.primaryCount + t.secondaryCount) / (this.primaryCount + this.secondaryCount) * t.entropy
        }), e
    }
    calculateGain(t, e) {
        return t - e
    ...
    recursiveDotString(t, e = "") {
        let r = "";
        return t ? (r += `${t.id} [label="${t.value}"];`, r += e ? `${e}--${t.id}` : "", r += t.tag ? `[label="${t.tag}"];` : "", t.childs.map(e => {
...
class FuzzySet {
    ...
    calculateMinsAndMax() {
        ...
        for (let r = 0; r < this.individuals.length; r++)
            for (let s = 0; s < e; s++) null == t[s][0] ? t[s][0] = this.individuals[r][s] : t[s][0] = Math.min(t[s][0], this.individuals[r][s]), null == t[s][1] ? t[s][1] = this.individuals[r][s] : t[s][1] = Math.max(t[s][1], this.individuals[r][s]);
        return t
    }
    normalization() {
        var t = [],
        ...
        for (let r = 0; r < this.individuals.length; r++) {
            let s = [];
            for (let t = 0; t < e; t++) this.individuals[r][t] <= this.minsAndMaxs[t][0] ? s.push(0) : this.individuals[r][t] >= this.minsAndMaxs[t][1] ? s.push(1) : s.push(((this.individuals[r][t] - this.minsAndMaxs[t][0]) / (this.minsAndMaxs[t][1] - this.minsAndMaxs[t][0])).toFixed(5));
            t.push(s)
        }
        return t
    }
    euclidean(t) {
        var e = this.individuals[0].length - 1,
            ...
            s = [];
        for (let e = 0; e < t.length; e++) t[e] <= this.minsAndMaxs[e][0] ? s.push(0) : t[e] >= this.minsAndMaxs[e][1] ? s.push(1) : s.push(((t[e] - this.minsAndMaxs[e][0]) / (this.minsAndMaxs[e][1] - this.minsAndMaxs[e][0])).toFixed(5));
        var i = [];
        for (const t of r) {
            var o = t.slice(0, e);
    ...
    clusterize(t, e, r) {
        ...
        for (let i = 0; i < r; i++) {
            ...
            for (let s = 0; s < t; s++) {
                ...
                for (; - 1 != r.findIndex(e => e === t);) t = e[Math.floor(Math.random() * e.length)];
                r.push(t)
            }
            ...
            let i = [],
                ...
                h = !0;
            e.forEach(t => {
                n = 0, a = 0, h = !0, r.forEach(e => {
                    let r = this.distance(t, e);
                    h ? (a = Math.abs(r), n = e, h = !h) : Math.abs(r) < a && (a = Math.abs(r), n = e), i.push([t, e, r])
                }), o.push([t, n, a])
            });
            let l = [],
                u = 0,
                c = [];
            do {
                l = c, c = [], u = 0, r.forEach((t, e) => {
                    let s = o.filter(e => e[1] == t).map(t => t[0]);
                    c.push(this.calculateMeanVariance(s)), u += s[1], r[e] = c[e][0]
                }), Number.isNaN(u) && (u = 0), i = [], o = [], n = 0, a = 0, h = !0, e.forEach(t => {
                    n = 0, a = 0, h = !0, r.forEach(e => {
                        let r = this.distance(t, e);
                        h ? (a = Math.abs(r), n = e, h = !h) : Math.abs(r) < a && (a = Math.abs(r), n = e), i.push([t, e, r])
                    }), o.push([t, n, a])
...
class _2DKMeans extends KMeans {
    ...
    clusterize(t, e, r) {
        ...
        for (let i = 0; i < r; i++) {
            ...
            for (let r = 0; r < t; r++) {
                let t = e[Math.floor(Math.random() * e.length)];
                for (; - 1 != i.findIndex(e => e === t);) t = e[Math.floor(Math.random() * e.length)];
                i.push(t)
            }
            let o = [],
                n = [],
                ...
                l = !0;
            e.forEach(t => {
                a = [0], h = 0, l = !0, i.forEach(e => {
                    let r = this.distance(t, e);
                    l ? (h = Math.abs(r), a = e, l = !l) : Math.abs(r) < h && (h = Math.abs(r), a = e), o.push([t, e, r])
                }), n.push([t, a, h])
            });
            let u = [],
                c = 0,
                ...
                m = 0;
            do {
                u = f, f = [], c = 0, i.forEach((t, e) => {
                    let r = n.filter(e => JSON.stringify(e[1]) == JSON.stringify(t)).map(t => t[0]);
                    f.push([this.calculateMeanVariance(r.map(t => t[0])), this.calculateMeanVariance(r.map(t => t[1]))]), c += r[1], i[e] = f[e][0]
                }), Number.isNaN(c) && (c = 0), o = [], n = [], a = 0, h = 0, l = !0, e.forEach(t => {
                    a = 0, h = 0, l = !0, i.forEach(e => {
                        let r = this.distance(t, e);
                        l ? (h = Math.abs(r), a = e, l = !l) : Math.abs(r) < h && (h = Math.abs(r), a = e), o.push([t, e, r])
                    }), n.push([t, a, h])
...
const distance = (t, e) => Math.sqrt(t.map((t, r) => e[r] - t).reduce((t, e) => t + e * e, 0));
class LinearModel {
    constructor() {
        this.isFit = !1
    }
...
class LinearRegression extends LinearModel {
    ...
    fit(t, e) {
        for (var r = 0, s = 0, i = 0, o = 0, n = 0; n < t.length; n++) r += t[n], s += e[n], i += t[n] * e[n], o += t[n] * t[n];
        this.m = (t.length * i - r * s) / (t.length * o - Math.pow(Math.abs(r), 2)), this.b = (s * o - r * i) / (t.length * o - Math.pow(Math.abs(r), 2)), this.isFit = !0
    }
    predict(t) {
        var e = [];
        if (this.isFit)
...
class NaiveBayes {
    ...
    insertCause(t, e) {
        ...
        for (let s = 0; s < this.causes.length; s++) {
            if (this.causes[s][0] === t) {
                r = !1, console.log("Naive Bayes - Error on insertCause: cause names must be unique");
                break
            }
            if (this.causes[s][1].length != e.length) {
                r = !1, console.log("Naive Bayes - Error on insertCause: all array lengths must be the same");
                break
            }
        }
    ...
    predict(t, e) {
        let r = this.getCauseByName(t),
            s = [],
            i = [];
        for (let t = 0; t < r.length; t++) i.includes(r[t]) || (s.push([r[t], 0]), i.push(r[t]));
        console.log(s);
        for (let r = 0; r < s.length; r++) {
            let i = this.getSimpleProbability([t, s[r][0]]);
            for (let o = 0; o < e.length; o++) i *= this.getConditionalProbability(e[o], [t, s[r][0]]);
            s[r][1] = i
        }
        console.log(s);
        let o = 0,
            n = "nothing :(";
        for (let t = 0; t < s.length; t++) s[t][1] > o && (o = s[t][1], n = s[t][0]);
        return [n, 100 * o + "%"]
    }
    ...
    getConditionalProbability(t, e) {
        let r = this.getCauseByName(t[0]),
            ...
            i = 0,
            o = 0;
        for (let n = 0; n < r.length; n++) s[n] == e[1] && (o++, r[n] == t[1] && i++);
        return i / o
    }
    getCauseByName(t) {
...
class Matriz {
    ...
    static resstar(t, e) {
        ...
        for (let s = 0; s < t.rows; s++)
            for (let i = 0; i < t.cols; i++) r.data[s][i] = t.data[s][i] - e.data[s][i];
        return r
    }
    mapear(t) {
        for (let e = 0; e < this.rows; e++)
    ...
    tirar_random() {
        for (let t = 0; t < this.rows; t++)
            for (let e = 0; e < this.cols; e++) this.data[t][e] = 2 * Math.random() - 1
    }
...
class LayerLink {
    constructor(t, e) {
        this.weights = new Matriz(e, t), this.bias = new Matriz(e, 1), this.weights.tirar_random(), this.bias.tirar_random()
    }
...
class NeuralNetwork {
    constructor(t, e) {
        if (t.length < 2) return console.error("Neural Network Needs Atleast 2 Layers To Work."), {
            layers: t
        };
        if (this.options = {
            ...
            }, this.learning_rate = .1, e) {
            if (e.learning_rate && this.Set_aprendizaje_rate(parseFloat(e.learning_rate)), !(e.activation && e.derivative && e.activation instanceof Function && e.derivative instanceof Function)) return console.error("Check Documentation to Learn How To Set Custom Activation Function"), console.warn("Documentation Link: http://github.com/AlexDenver"), {
                options: e
            };
            this.options.activation = e.activation, this.options.derivative = e.derivative
        }
        this.layerCount = t.length - 1, this.inputs = t[0], this.output_nodes = t[t.length - 1], this.layerLink = [];
        for (let e = 1, r = 0; r < this.layerCount; e++, r++) {
            if (t[e] <= 0) return console.error("A Layer Needs To Have Atleast One Node (Neuron)."), {
                layers: t
            };
    ...
    Predecir(t) {
        if (t.length !== this.inputs) return console.error(`This Instance of NeuralNetwork Expects ${this.inputs} Inputs, ${t.length} Provided.`), {
            inputs: t
        };
        let e = Matriz.get_array(t);
        for (let t = 0; t < this.layerCount; t++)(e = Matriz.multiplicar(this.layerLink[t].obtener_Weights(), e)).summar(this.layerLink[t].obtener_Bias()), e.mapear(this.options.activation);
        return e.convert_to_array()
    }
    Set_aprendizaje_rate(t) {
        t > 1 && t < 100 ? ((t /= 100) > .3 && console.warn("It is recommended to Set Lower Learning Rates"), this.learning_rate = t) : console.error("Set Learning Rate Between (0 - 1) or (1 - 100)")
    }
    Entrenar(t, e) {
        if (t.length !== this.inputs) return console.error(`This Instance of NeuralNetwork Expects ${this.inputs} Inputs, ${t.length} Provided.`), {
            inputs: t
        };
        if (e.length !== this.output_nodes) return console.error(`This Instance of NeuralNetwork Expects ${this.output_nodes} Outputs, ${e.length} Provided.`), {
            outputs: e
        };
        let r = Matriz.get_array(t),
            s = [];
        s[0] = r;
        for (let t = 0; t < this.layerCount; t++) s[t + 1] = Matriz.multiplicar(this.layerLink[t].obtener_Weights(), s[t]), s[t + 1].summar(this.layerLink[t].obtener_Bias()), s[t + 1].mapear(this.options.activation);
        let i = Matriz.get_array(e),
            o = [],
            n = [];
        o[this.layerCount] = Matriz.resstar(i, s[this.layerCount]);
        for (let t = this.layerCount; t > 0; t--) {
            n[t] = Matriz.mapear(s[t], this.options.derivative), n[t].multiplicar(o[t]), n[t].multiplicar(this.learning_rate);
            let e = Matriz.transpuesta(s[t - 1]),
                r = Matriz.multiplicar(n[t], e);
            this.layerLink[t - 1].summar(r, n[t]), o[t - 1] = Matriz.multiplicar(Matriz.transpuesta(this.layerLink[t - 1].obtener_Weights()), o[t])
        }
    }
}
class PLS {
    constructor(t, e) {
        if (!0 === t) this.meanX = e.meanX, this.stdDevX = e.stdDevX, this.meanY = e.meanY, this.stdDevY = e.stdDevY, this.PBQ = Matrix.checkMatrix(e.PBQ), this.R2X = e.R2X, this.scale = e.scale, this.scaleMethod = e.scaleMethod, this.tolerance = e.tolerance;
        else {
            let {
                tolerance: e = 1e-5,
                scale: r = !0
            } = t;
            this.tolerance = e, this.scale = r, this.latentVectors = t.latentVectors
        }
    }
    train(t, e) {
        if (t = Matrix.checkMatrix(t), e = Matrix.checkMatrix(e), t.length !== e.length) throw new RangeError("The number of X rows must be equal to the number of Y rows");
        this.meanX = t.mean("column"), this.stdDevX = t.standardDeviation("column", {
            mean: this.meanX,
            unbiased: !0
        }), this.meanY = e.mean("column"), this.stdDevY = e.standardDeviation("column", {
            mean: this.meanY,
            unbiased: !0
        }), this.scale && (t = t.clone().subRowVector(this.meanX).divRowVector(this.stdDevX), e = e.clone().subRowVector(this.meanY).divRowVector(this.stdDevY)), void 0 === this.latentVectors && (this.latentVectors = Math.min(t.rows - 1, t.columns));
        let r, s, i, o, n = t.rows,
            a = t.columns,
            h = e.rows,
            l = e.columns,
            u = t.clone().mul(t).sum(),
        ...
        for (; norm(e) > f && M < m;) {
            ...
            for (r = Matrix.zeros(n, 1); norm(c.clone().sub(r)) > f;)(s = a.mmul(m)).div(norm(s)), r = c, c = t.mmul(s), (i = h.mmul(c)).div(norm(i)), m = e.mmul(i);
            r = c;
            let x = a.mmul(r),
                v = r.transpose().mmul(r).get(0, 0),
                k = norm(o = x.div(v));
            o.div(k), r.mul(k), s.mul(k), x = m.transpose().mmul(r), v = r.transpose().mmul(r).get(0, 0);
            let R = x.div(v).get(0, 0);
            t.sub(r.mmul(o.transpose())), e.sub(r.clone().mul(R).mmul(i.transpose())), p.setColumn(M, r), w.setColumn(M, o), g.setColumn(M, m), d.setColumn(M, i), b.setColumn(M, s), y.set(M, M, R), M++
        }
        M--, p = p.subMatrix(0, p.rows - 1, 0, M), w = w.subMatrix(0, w.rows - 1, 0, M), g = g.subMatrix(0, g.rows - 1, 0, M), d = d.subMatrix(0, d.rows - 1, 0, M), b = b.subMatrix(0, b.rows - 1, 0, M), y = y.subMatrix(0, M, 0, M), this.ssqYcal = c, this.E = t, this.F = e, this.T = p, this.P = w, this.U = g, this.Q = d, this.W = b, this.B = y, this.PBQ = w.mmul(y).mmul(d.transpose()), this.R2X = r.transpose().mmul(r).mmul(o.transpose().mmul(o)).div(u).get(0, 0)
    }
    predict(t) {
    ...
    if (e)
        for (let e = 0; e < t.length; ++e)
            for (let r = 0; r < t[e].length; ++r) {
                ...
                for (let e = 0; e < t.length; ++e) t[e] = new Matrix(t[e]);
    return t
}
class AbstractMatrix {
    ...
    static min(t, e) {
        ...
        let r = t.rows,
            ...
            i = new Matrix(r, s);
        for (let o = 0; o < r; o++)
            for (let r = 0; r < s; r++) i.set(o, r, Math.min(t.get(o, r), e.get(o, r)));
        return i
    }
    static max(t, e) {
        t = this.checkMatrix(t), e = this.checkMatrix(e);
        let r = t.rows,
            ...
            i = new this(r, s);
        for (let o = 0; o < r; o++)
            for (let r = 0; r < s; r++) i.set(o, r, Math.max(t.get(o, r), e.get(o, r)));
        return i
    }
    ...
    isEchelonForm() {
        let t = 0,
            ...
            i = !1;
        for (; t < this.rows && s;) {
            for (e = 0, i = !1; e < this.columns && !1 === i;) 0 === this.get(t, e) ? e++ : 1 === this.get(t, e) && e > r ? (i = !0, r = e) : (s = !1, i = !0);
            t++
        }
        return s
    }
        ...
        for (; e < t.rows && r < t.columns;) {
            ...
            if (0 === t.get(s, r)) r++;
                ...
                for (let s = e + 1; s < t.rows; s++) {
                    ...
                    t.set(s, r, 0);
                    for (let o = r + 1; o < t.columns; o++) t.set(s, o, t.get(s, o) - t.get(e, o) * i)
                }
                e++, r++
            }
        }
    ...
    repeat(t = {}) {
        ...
        for (let t = 0; t < e; t++)
            for (let e = 0; e < r; e++) s.setSubMatrix(this, this.rows * t, this.columns * e);
        return s
    }
    fill(t) {
        for (let e = 0; e < this.rows; e++)
    ...
    addRowVector(t) {
        ...
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.set(e, r, this.get(e, r) + t[r]);
        return this
    }
    subRowVector(t) {
        t = checkRowVector(this, t);
    ...
    addColumnVector(t) {
        ...
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.set(e, r, this.get(e, r) + t[e]);
        return this
    }
    subColumnVector(t) {
        t = checkColumnVector(this, t);
    ...
    max() {
        ...
        let t = this.get(0, 0);
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.get(e, r) > t && (t = this.get(e, r));
        return t
    }
    maxIndex() {
        checkNonEmpty(this);
        let t = this.get(0, 0),
            e = [0, 0];
        for (let r = 0; r < this.rows; r++)
            for (let s = 0; s < this.columns; s++) this.get(r, s) > t && (t = this.get(r, s), e[0] = r, e[1] = s);
        return e
    }
    min() {
        if (this.isEmpty()) return NaN;
    ...
    maxRow(t) {
        ...
        let e = this.get(t, 0);
        for (let r = 1; r < this.columns; r++) this.get(t, r) > e && (e = this.get(t, r));
        return e
    }
    maxRowIndex(t) {
        ...
        let e = this.get(t, 0),
            r = [t, 0];
        for (let s = 1; s < this.columns; s++) this.get(t, s) > e && (e = this.get(t, s), r[1] = s);
        return r
    }
    minRow(t) {
        if (checkRowIndex(this, t), this.isEmpty()) return NaN;
    ...
    maxColumn(t) {
        ...
        let e = this.get(0, t);
        for (let r = 1; r < this.rows; r++) this.get(r, t) > e && (e = this.get(r, t));
        return e
    }
    maxColumnIndex(t) {
        ...
        let e = this.get(0, t),
            r = [0, t];
        for (let s = 1; s < this.rows; s++) this.get(s, t) > e && (e = this.get(s, t), r[0] = s);
        return r
    }
    minColumn(t) {
        if (checkColumnIndex(this, t), this.isEmpty()) return NaN;
    ...
    norm(t = "frobenius") {
        ...
        if ("frobenius" === t) {
            for (let t = 0; t < this.rows; t++)
                for (let r = 0; r < this.columns; r++) e += this.get(t, r) * this.get(t, r);
            return Math.sqrt(e)
        }
    ...
    cumulativeSum() {
        let t = 0;
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) t += this.get(e, r), this.set(e, r, t);
        return this
    }
    dot(t) {
    ...
    strassen3x3(t) {
        ...
        const r = this.get(0, 0),
            ...
            q = S + C + N + T + h * f,
            O = k + R + E + A + u * b;
        return e.set(0, 0, D), e.set(0, 1, j), e.set(0, 2, P), e.set(1, 0, F), e.set(1, 1, B), e.set(1, 2, $), e.set(2, 0, _), e.set(2, 1, q), e.set(2, 2, O), e
    }
    mmulStrassen(t) {
        t = Matrix.checkMatrix(t);
        let e = this.clone(),
        ...
        s !== i && console.warn(`Multiplying ${r} x ${s} and ${i} x ${o} matrix: dimensions do not match.`);
        let a = Math.max(r, i),
            h = Math.max(s, o);
        return function t(e, r, s, i) {
            if (s <= 512 || i <= 512) return e.mmul(r);
            s % 2 == 1 && i % 2 == 1 ? (e = n(e, s + 1, i + 1), r = n(r, s + 1, i + 1)) : s % 2 == 1 ? (e = n(e, s + 1, i), r = n(r, s + 1, i)) : i % 2 == 1 && (e = n(e, s, i + 1), r = n(r, s, i + 1));
            ...
            return (S = (S = (S = (S = S.setSubMatrix(k, 0, 0)).setSubMatrix(R, k.rows, 0)).setSubMatrix(E, 0, k.columns)).setSubMatrix(A, k.rows, k.columns)).subMatrix(0, s - 1, 0, i - 1)
    ...
    kroneckerProduct(t) {
        ...
        for (let n = 0; n < e; n++)
            for (let e = 0; e < r; e++)
                for (let r = 0; r < s; r++)
                    for (let a = 0; a < i; a++) o.set(s * n + r, i * e + a, this.get(n, e) * t.get(r, a));
        return o
    }
    kroneckerSum(t) {
        if (t = Matrix.checkMatrix(t), !this.isSquare() || !t.isSquare()) throw new Error("Kronecker Sum needs two Square Matrices");
        let e = this.rows,
            r = t.rows,
    ...
    center(t, e = {}) {
        ...
        switch (t) {
            ...
            case void 0:
                if ("number" != typeof r) throw new TypeError("center must be a number");
...
AbstractMatrix.prototype.klass = "Matrix", "undefined" != typeof Symbol && (AbstractMatrix.prototype[Symbol.for("nodejs.util.inspect.custom")] = inspectMatrix), AbstractMatrix.random = AbstractMatrix.rand, AbstractMatrix.randomInt = AbstractMatrix.randInt, AbstractMatrix.diagonal = AbstractMatrix.diag, AbstractMatrix.prototype.diagonal = AbstractMatrix.prototype.diag, AbstractMatrix.identity = AbstractMatrix.eye, AbstractMatrix.prototype.negate = AbstractMatrix.prototype.neg, AbstractMatrix.prototype.tensorProduct = AbstractMatrix.prototype.kroneckerProduct;
class Matrix extends AbstractMatrix {
    constructor(t, e) {
        if (super(), Matrix.isMatrix(t)) return t.clone();
        if (Number.isInteger(t) && t >= 0) {
            if (this.data = [], !(Number.isInteger(e) && e >= 0)) throw new TypeError("nColumns must be a positive integer");
            ...
            {
                const r = t;
                if ("number" != typeof(e = (t = r.length) ? r[0].length : 0)) throw new TypeError("Data must be a 2D array with at least one element");
                this.data = [];
                for (let s = 0; s < t; s++) {
                    if (r[s].length !== e) throw new RangeError("Inconsistent array dimensions");
    ...
    removeRow(t) {
        return checkRowIndex(this, t), this.data.splice(t, 1), this.rows -= 1, this
    }
    addRow(t, e) {
        return void 0 === e && (e = t, t = this.rows), checkRowIndex(this, t, !0), e = Float64Array.from(checkRowVector(this, e)), this.data.splice(t, 0, e), this.rows += 1, this
    }
    removeColumn(t) {
        checkColumnIndex(this, t);
        for (let e = 0; e < this.rows; e++) {
    ...
    addColumn(t, e) {
        void 0 === e && (e = t, t = this.columns), checkColumnIndex(this, t, !0), e = checkColumnVector(this, e);
        for (let r = 0; r < this.rows; r++) {
...
function inspectData(t, e, r, s) {
    const {
        rows: i,
        columns: o
    } = t, n = Math.min(i, e), a = Math.min(o, r), h = [];
    for (let e = 0; e < n; e++) {
        let r = [];
        for (let i = 0; i < a; i++) r.push(formatNumber(t.get(e, i), s));
        h.push(`${r.join(" ")}`)
    }
    return a !== o && (h[h.length - 1] += ` ... ${o-r} more columns`), n !== i && h.push(`... ${i-e} more rows`), h.join(`\n${indentData}`)
}
...
function installMathOperations(t, e) {
    t.prototype.add = function(t) {
        ...
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.set(e, r, this.get(e, r) + t);
        return this
        ...
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.set(e, r, this.get(e, r) + t.get(e, r));
        return this
    }, t.add = function(t, r) {
        ...
        for (let t = 0; t < this.rows; t++)
            for (let e = 0; e < this.columns; e++) this.set(t, e, Math.fround(this.get(t, e)));
        return this
    }, t.fround = function(t) {
        ...
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.set(e, r, Math.pow(this.get(e, r), t));
        return this
    }, t.prototype.powM = function(t) {
        if (t = e.checkMatrix(t), this.rows !== t.rows || this.columns !== t.columns) throw new RangeError("Matrices dimensions must be equal");
        for (let e = 0; e < this.rows; e++)
            for (let r = 0; r < this.columns; r++) this.set(e, r, Math.pow(this.get(e, r), t.get(e, r)));
        return this
    }
}
...
function getScaleByRow(t) {
    ...
    for (let r = 0; r < t.rows; r++) {
        let s = 0;
        for (let e = 0; e < t.columns; e++) s += Math.pow(t.get(r, e), 2) / (t.columns - 1);
        e.push(Math.sqrt(s))
    }
    return e
}
...
function getScaleByColumn(t) {
    ...
    for (let r = 0; r < t.columns; r++) {
        let s = 0;
        for (let e = 0; e < t.rows; e++) s += Math.pow(t.get(e, r), 2) / (t.rows - 1);
        e.push(Math.sqrt(s))
    }
    return e
}
...
function checkIndices(t, e, r) {
    return {
        row: checkRowIndices(t, e),
        column: checkColumnIndices(t, r)
    }
}
...
function checkRange(t, e, r, s, i) {
    ...
    if (checkNumber("startRow", e), checkNumber("endRow", r), checkNumber("startColumn", s), checkNumber("endColumn", i), e > r || s > i || e < 0 || e >= t.rows || r < 0 || r >= t.rows || s < 0 || s >= t.columns || i < 0 || i >= t.columns) throw new RangeError("Submatrix indices are out of range")
}
...
class PolynomialRegression extends PolynomialModel {
    ...
    fit(t, e, r) {
        ...
        for (let r = 0; r < s; r++)
            for (let s = 0; s < i; s++) {
                ...
                if (0 == r && 0 == s) n = t.length;
                    ...
                    for (let e = 0; e < t.length; e++) n += Math.pow(t[e], s + r);
                o[r][s] = n
            }
        for (let t = 1; t < s; t++)
            for (let e = 0; e <= t - 1; e++) {
        ...
        for (let t = s - 1; t > -1; t--)
            for (let e = s - 1; e > -1; e--) t == e ? o[t][i - 1] = o[t][i - 1] / o[t][e] : 0 != o[t][e] && (o[t][i - 1] -= o[t][e] * o[e][i - 1]);
    ...
    predict(t) {
        ...
        if (this.isFit)
            for (let r = 0; r < t.length; r++) {
                let s = 0;
                for (let e = 0; e < this.solutions.length; e++) s += this.solutions[e] * Math.pow(t[r], e);
                e.push(s)
            }
        return e
    }
    calculateR2(t, e) {
        let r = new Array(t.length),
            s = this.predict(t),
            i = 0;
        for (let o = 0; o < t.length; o++) i += e[o], r[o] = Math.pow(e[o] - s[o], 2);
        let o = 0,
            n = 0;
        for (let s = 0; s < t.length; s++) o += r[s], n += Math.pow(e[s] - i / t.length, 2);
        let a = (n - o) / n;
        this.error = a
    }
    getError() {
...
var svmjs = function(t) {
    ...
    function r(t) {
        return function(e, r) {
            for (var s = 0, i = 0; i < e.length; i++) s += (e[i] - r[i]) * (e[i] - r[i]);
    ...
    return e.prototype = {
        train: function(t, e, i) {
            ...
            if (this.kernelType = "linear", "kernel" in i)
                if ("string" == typeof i.kernel) {
                    if ("linear" === i.kernel && (this.kernelType = "linear", u = s), "rbf" === i.kernel) {
                        var c = i.rbfsigma || .5;
            ...
            var f = this.N;
            if (this.D = t[0].length, this.D, this.alpha = function(t) {
                    for (var e = new Array(t), r = 0; r < t; r++) e[r] = 0;
                    return e
                }(f), this.b = 0, this.usew_ = !1, i.memoize) {
                this.kernelResults = new Array(f);
                for (var m = 0; m < f; m++) {
                    this.kernelResults[m] = new Array(f);
                    for (var p = 0; p < f; p++) this.kernelResults[m][p] = u(t[m], t[p])
                }
            }
            for (var w, g = 0, d = 0; d < l && g < h;) {
                ...
                for (m = 0; m < f; m++) {
                    ...
                    if (e[m] * b < -n && this.alpha[m] < o || e[m] * b > n && this.alpha[m] > 0) {
                        for (p = m; p === m;) 0, w = this.N, p = Math.floor(Math.random() * (w - 0) + 0);
                        var M = this.marginOne(t[p]) - e[p];
                        ai = this.alpha[m], aj = this.alpha[p];
                        var x = 0,
                            v = o;
                        if (e[m] === e[p] ? (x = Math.max(0, ai + aj - o), v = Math.min(o, ai + aj)) : (x = Math.max(0, aj - ai), v = Math.min(o, o + aj - ai)), Math.abs(x - v) < 1e-4) continue;
                        var k = 2 * this.kernelResult(m, p) - this.kernelResult(m, m) - this.kernelResult(p, p);
                        if (k >= 0) continue;
                        var R = aj - e[p] * (b - M) / k;
                        if (R > v && (R = v), R < x && (R = x), Math.abs(aj - R) < 1e-4) continue;
                        this.alpha[p] = R;
                        var E = ai + e[m] * e[p] * (aj - R);
                        this.alpha[m] = E;
                        var A = this.b - b - e[m] * (E - ai) * this.kernelResult(m, m) - e[p] * (R - aj) * this.kernelResult(m, p),
                            S = this.b - M - e[m] * (E - ai) * this.kernelResult(m, p) - e[p] * (R - aj) * this.kernelResult(p, p);
                        this.b = .5 * (A + S), E > 0 && E < o && (this.b = A), R > 0 && R < o && (this.b = S), y++
                    }
                }
                g++, 0 == y ? d++ : d = 0
            }
            if ("linear" === this.kernelType)
                for (this.w = new Array(this.D), p = 0; p < this.D; p++) {
                    ...
                    var N = [],
                        T = [],
                        I = [];
                    for (m = 0; m < this.N; m++) this.alpha[m] > a && (N.push(this.data[m]), T.push(this.labels[m]), I.push(this.alpha[m]));
                    this.data = N, this.labels = T, this.alpha = I, this.N = this.data.length
                }
            var z = {};
            return z.iters = g, z
        },
        marginOne: function(t) {
            var e = this.b;
            if (this.usew_)
                for (var r = 0; r < this.D; r++) e += t[r] * this.w[r];
            else
                for (var s = 0; s < this.N; s++) e += this.alpha[s] * this.labels[s] * this.kernel(t, this.data[s]);
            return e
        },
        ...
        margins: function(t) {
            for (var e = t.length, r = new Array(e), s = 0; s < e; s++) r[s] = this.marginOne(t[s]);
            return r
        },
        kernelResult: function(t, e) {
            return this.kernelResults ? this.kernelResults[t][e] : this.kernel(this.data[t], this.data[e])
        },
        predict: function(t) {
            for (var e = this.margins(t), r = 0; r < e.length; r++) e[r] = e[r] > 0 ? 1 : -1;
            return e
        },
        getWeights: function() {
            for (var t = new Array(this.D), e = 0; e < this.D; e++) {
                for (var r = 0, s = 0; s < this.N; s++) r += this.alpha[s] * this.labels[s] * this.data[s][e];
                t[e] = r
            }
            return {
                w: t,
        ...
        toJSON: function() {
            return "custom" === this.kernelType ? (console.log("Can't save this SVM because it's using custom, unsupported kernel..."), {}) : (json = {}, json.N = this.N, json.D = this.D, json.b = this.b, json.kernelType = this.kernelType, "linear" === this.kernelType && (json.w = this.w), "rbf" === this.kernelType && (json.rbfSigma = this.rbfSigma, json.data = this.data, json.labels = this.labels, json.alpha = this.alpha), json)
        },
        fromJSON: function(t) {
    ...
    }, (t = t || {}).SVM = e, t.makeRbfKernel = r, t.linearKernel = s, t
...
function joinArrays() {
    ...
    if (6 == arguments.length) {
        ...
        for (var e = 0; e < arguments[1].length; e++) t.push([arguments[1][e], arguments[3][e], arguments[5][e]])
    }
    return t
}
...
function Perceptron(t) {
    t || (t = {});
    var e, r = "debug" in t && t.debug,
        s = "weights" in t ? t.weights.slice() : [],
        i = "threshold" in t ? t.threshold : 1;
    e = "learningrate" in t ? t.learningrate : .1;
    var o = [],
        n = {
            weights: s,
            retrain: function() {
            ...
            train: function(e, a) {
                ...
                if (o.push({
                        ...
                        target: a,
                        prev: h
                    }), r && console.log("> training %s, expecting: %s got: %s", e, a, h), h == a) return !0;
            ...
            adjust: function(t, r, i, o) {
                ...
                if (s[o] += a, isNaN(s[o])) throw new Error("weights[" + o + "] went to NaN!!")
            },
            ...
            perceive: function(t, e, r) {
                ...
                return o += i * s[s.length - 1], (r = r || (t => Number(this.sigmoid(t) >= .5))) ? r(o) : e ? o : o > 0 ? 1 : 0
            },
            sigmoid: function(t) {
...
class LogisticRegression extends LogisticModel {
    constructor() {
        super(), this.alpha = .001, this.lambda = 0, this.iterations = 100
    }
    fit(t) {
        ...
        for (var c = 0; c < this.iterations; ++c) {
            ...
            for (n = 0; n < this.dim; ++n) this.theta[n] = this.theta[n] - this.alpha * g[n]
        }
        return this.threshold = this.computeThreshold(h, i), {
            theta: this.theta,
    ...
    cost(t, s, h) {
        for (var i = t.length, r = 0, a = 0; a < i; ++a) {
            var o = s[a],
                e = t[a];
            r += -(o * Math.log(this.h(e, h)) + (1 - o) * Math.log(1 - this.h(e, h))) / i
        }
        for (var l = 0; l < this.dim; ++l) r += this.lambda * h[l] * h[l] / (2 * i);
        return r
    }
}
...
function predecirCluster(t, l, a) {
    let e, n;
    e = 1 === t ? calcularDistanciaManhattan(l, a) : calcularDistanciaEuclidiana(l, a);
    for (let t = 0; t < e.length; t++) n ? e[t] < n && (n = e[t]) : n = e[t];
    let c = "";
    for (let t = 0; t < e.length; t++) e[t] === n && (0 === c.length ? c = l[t][2] : c += "," + l[t][2]);
    return `El individuo ${a[0]} pertenece a: ${c}`
}
var atributos = new Array(new Array("Outlook", "Temperature", "Humidity", "Windy", "Class"), new Array("sunny", "hot", "high", "false", "N"), new Array("sunny", "hot", "high", "true", "N"), new Array("overcast", "hot", "high", "false", "P"), new Array("rain", "mild", "high", "false", "P"), new Array("rain", "cool", "normal", "false", "P"), new Array("rain", "cool", "normal", "true", "N"), new Array("overcast", "cool", "normal", "true", "P"), new Array("sunny", "mild", "high", "false", "N"), new Array("sunny", "cool", "normal", "false", "P"), new Array("rain", "mild", "normal", "false", "P"), new Array("sunny", "mild", "normal", "true", "P"), new Array("overcast", "mild", "high", "true", "P"), new Array("overcast", "hot", "normal", "false", "P"), new Array("rain", "mild", "high", "true", "N")),
...
function cantidad(e) {
    let t = 0;
    for (let a = 1; a < atributos.length; a++) e == atributos[a][atributos[0].length - 1] && t++;
    return t
}
...
function probabilidad(e) {
    ...
    for (let r = 0; r < condicion.length; r++) {
        ...
        for (let t = 0; t < atributos.length; t++)
            for (let a = 0; a < atributos[t].length; a++) n == atributos[t][a] && (e == atributos[t][atributos[0].length - 1] && o++, l++);
        t[r] = o, a[r] = l
    }
    let n = totalPerder;
...
function imprimirTabla(e, t) {
    ...
    for (let e = 0; e < atributos.length; e++) {
        ...
        0 != r && (o = document.createTextNode(r)), r++, l.appendChild(o), n.appendChild(l);
    ...
    document.getElementById("salida2").appendChild(d), document.getElementById("salida3").appendChild(i)
}

function inicio() {
    totalGanar = cantidad(varGanar), totalPerder = cantidad(varPerder), total = totalGanar + totalPerder;
    let e = ganar(),
        t = perder();
    imprimirTabla(e, t);
    var a = document.createTextNode(""),
        r = document.createTextNode(condicion);
    e > t ? (console.log("Ganar"), a = document.createTextNode("Ganar")) : (console.log("No ganar"), a = document.createTextNode("No ganar")), document.getElementById("salida4").appendChild(a), document.getElementById("salida1").appendChild(r)
}
